...
//        bakeryObjects = new StoreObjects[]{ new Bagels(rand.nextInt(20)) , new Croissants(rand.nextInt(20)) , new Donuts(rand.nextInt(20)) };
        ...
        fruitObjects = new StoreObjects[]{ new StoreObjects("Apple",2.5f, rand.nextInt(20), "pic/apple.png") , new StoreObjects("Banana",7.0f, rand.nextInt(20), "pic/banana.png") , new StoreObjects("Orange",10.00f, rand.nextInt(20), "pic/orange.png") };
        soupObjects = new StoreObjects[]{ new StoreObjects("Tomato Soup",6.0f, rand.nextInt(20), "pic/tomatosoup.png") , new StoreObjects("Broccoli Cheddar Soup",6.0f, rand.nextInt(20), "pic/broccolicheddarsoup.png") , new StoreObjects("Chicken Noodle Soup",6.0f, rand.nextInt(20), "pic/soup.png") };
        coffeeObjects = new StoreObjects[]{ new StoreObjects("French Vanilla Coffee",2.50f, rand.nextInt(20), "pic/coffee.png") , new StoreObjects("Regular Coffee",2.50f, rand.nextInt(20), "pic/coffee.png") , new StoreObjects("Seasonal Coffee",2.50f, rand.nextInt(20), "pic/coffee.png"), new StoreObjects("Napkin",.50f, rand.nextInt(50), "pic/napkin.png"), new StoreObjects("Utensils",.75f, rand.nextInt(20), "pic/utensils.png")};
        coolerObjects = new StoreObjects[]{ new StoreObjects("Caesar Salad",9.0f, rand.nextInt(20), "pic/salad.png") , new StoreObjects("Chef Salad",12.5f, rand.nextInt(20), "pic/salad.png") , new StoreObjects("Ham Wrap",8.5f, rand.nextInt(20), "pic/sandwich.png"), new StoreObjects("Turkey Wrap",8.5f, rand.nextInt(20), "pic/sandwich.png") , new StoreObjects("Veggie Wrap",9.5f, rand.nextInt(20), "pic/sandwich.png") };
        bakeryObjects = new StoreObjects[]{ new StoreObjects("Bagel",3.5f, rand.nextInt(20), "pic/bagel.png") , new StoreObjects("Croissant",5.0f, rand.nextInt(20), "pic/croissant.png") , new StoreObjects("Donut",4.99f, rand.nextInt(20), "pic/donut.png") };
