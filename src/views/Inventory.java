    ...
    public Inventory() {
        ...
        content = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                g.drawImage(new ImageIcon("pic/inventory.png").getImage(), 0, 0, (int) Math.round(this.getWidth()), (int) Math.round(container.getHeight()), null);
            }
        };
        ...
        sideBar = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                super.paintComponent(g);
                getParent().getParent().requestFocus();
                g.drawImage(new ImageIcon("pic/sidebar.png").getImage(), 0, 0, (int) Math.round(this.getWidth()), (int) Math.round(container.getHeight()), null);
